...
class OrdersController < ApplicationController
	SAVE_LABEL_LOCATION = "/home/amitej/shipping/labels"
	UPS_ORIGIN_NUMBER = "X4X091"
...
@options = {
	        ...
	        #:attention_name => "Receiving Department",
	       	# :origin_account => UPS_ORIGIN_NUMBER
...
label_specification =  {:print_code => "GIF", :format_code => "GIF", :user_agent => "Mozilla/4.5"}
 ...
 debugger
 @label = @ups.obtain_shipping_labels(@origin, @destination, @packages, @options={})
